...
## Posibles ajustes según tu campus

Algunos campus o evaluadores revisan detalles concretos como:

- nombre exacto del dominio (`login.42.fr` o `login.42.com`),
- uso exclusivo del puerto `443`,
